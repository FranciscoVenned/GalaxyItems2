...
public class MjolnirThorRender implements IItemRenderer {
    private final MjolnirThor model;

    public MjolnirThorRender() {
        this.model = new MjolnirThor();
    }
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        Minecraft.getMinecraft().getTextureManager()
                .bindTexture(new ResourceLocation("galaxycore", "textures/items/mjolnir.png"));

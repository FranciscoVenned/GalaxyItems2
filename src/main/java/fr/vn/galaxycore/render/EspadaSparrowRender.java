...
import fr.vn.galaxycore.model.EspadaSparrowModel;
...
public class EspadaSparrowRender implements IItemRenderer {
    private final EspadaSparrowModel model;

    public EspadaSparrowRender() {
        this.model = new EspadaSparrowModel();
    }
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        Minecraft.getMinecraft().getTextureManager()
                .bindTexture(new ResourceLocation("galaxycore", "textures/items/espadasparrow.png"));

...
import fr.vn.galaxycore.model.PicoModel;
import fr.vn.galaxycore.model.StormBreaker;
...
public class StormBreakerRender implements IItemRenderer {
    private final StormBreaker model;

    public StormBreakerRender() {
        this.model = new StormBreaker();
    }
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        Minecraft.getMinecraft().getTextureManager()
                .bindTexture(new ResourceLocation("galaxycore", "textures/items/espadamodel.png"));

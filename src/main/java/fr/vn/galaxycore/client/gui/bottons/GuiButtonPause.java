//package fr.vn.galaxycore.client.gui.bottons;
//
...
//    public GuiButtonPause(int action, int x, int y, String name) {
//        super(action, x, y, 200, 20, name);
//    }
//
//    public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
//        if (this.visible) {
//            FontRenderer fontrenderer = p_146112_1_.fontRenderer;
//            p_146112_1_.getTextureManager().bindTexture(new ResourceLocation("galaxycore", "textures/gui/buttonsIcons.png"));
